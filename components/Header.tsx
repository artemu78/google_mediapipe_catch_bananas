    ...
    return (
        <header className="relative w-full p-4 bg-slate-900/80 backdrop-blur-sm shadow-md z-10 flex items-center justify-center">
            ...
            <button
                ...
                className="absolute top-1/2 right-4 -translate-y-1/2 p-2 rounded-full bg-slate-700/50 hover:bg-slate-600/70 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-400"
